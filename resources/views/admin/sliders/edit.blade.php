        ...
        <div class="p-4 sm:p-6 lg:p-8">
            <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <img src="{{ $slider->image_url }}" alt="Current slide" class="rounded-2xl border border-slate-200 max-h-48 w-full object-cover">
                </div>

                <!-- Replace Image -->
                <div class="mb-6">
                    <label class="block text-sm font-bold text-slate-700 mb-2">Replace Image <span class="text-slate-400 font-normal">(optional)</span></label>
                    <p class="text-xs text-slate-400 mb-3">Upload a new image to replace the current one. Recommended: 1920×600px, max 5MB.</p>
                    ...
                    <div id="preview" class="mt-3 hidden">
                        <p class="text-xs font-semibold text-slate-500 mb-2">New Image Preview:</p>
                ...
                <div class="mb-6">
                    ...
                    <input type="url" name="link" value="{{ old('link', $slider->link) }}" placeholder="https://example.com/products/..." 
                ...
                <div class="flex items-center gap-3 pt-6 border-t border-slate-200">
                    <button type="submit" class="px-6 py-2.5 bg-primary-600 hover:bg-primary-700 text-white rounded-xl text-sm font-bold transition-all shadow-md shadow-primary-500/20">
                        <i class="fa-solid fa-save mr-1.5"></i> Update Slide
                    </button>
